...
extern std::function<std::optional<std::list<MANUFACTURER_TYPE>>(Conatiner&) > uniqueCarBrands;

extern std::function<std::optional<std::list<MANUFACTURER_TYPE>>(Conatiner&, int) > modelsAboveThreshold; 
