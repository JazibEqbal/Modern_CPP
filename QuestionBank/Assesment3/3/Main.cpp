...
int main()
{
    ...
    // 3
    auto ans1 = findMaxAccountBalanceId(account, TRANSACTION_TYPE::CARD);
    std::cout << "Account ID with maximum balance is: ";
    std::visit([](auto &&arg)
               { std::cout << arg; },
               ans1);
    std::cout << "\n";
    ...
    // 5
    auto nth = nthTransactionId(account, 2, 3);
    std::cout << "Nth Transaction ID is: ";
    std::visit([](auto &&arg)
               { std::cout << arg; },
               nth);
    std::cout << "\n";
    ...
    // 6
    std::cout << "Average Transaction amount is: " << averageTransactionAmount(account, 1) << "\n";
